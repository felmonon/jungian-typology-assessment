...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .proof-strip li { margin: 0; padding: 7px 10px; border: 1px solid var(--jung-border-light); border-radius: 8px; background: rgba(255,255,255,0.72); color: var(--jung-secondary); font-family: "Space Grotesk", Verdana, sans-serif; font-size: 0.82rem; font-weight: 600; line-height: 1.25; }
  ...
  .save-link-panel h2 { border: 0; margin: 0; padding: 0; font-family: "Space Grotesk", Verdana, sans-serif; font-size: 1.04rem; line-height: 1.25; }
  ...
  .save-link-form input[type="email"] { min-height: 44px; width: 100%; border: 1px solid var(--jung-border); border-radius: 8px; background: var(--jung-surface); color: var(--jung-dark); font: 600 0.95rem "Space Grotesk", Verdana, sans-serif; padding: 0 12px; }
  .save-link-form button { min-height: 44px; border: 0; border-radius: 8px; background: var(--jung-accent); color: white; cursor: pointer; font: 700 0.92rem "Space Grotesk", Verdana, sans-serif; padding: 0 16px; }
  ...
  .creator-public-link { margin: 16px 0 0; padding: 12px 14px; border: 1px solid var(--jung-border-light); border-radius: 8px; background: var(--jung-surface-alt); font-family: "Space Grotesk", Verdana, sans-serif; font-size: 0.9rem; }
  ...
  .copy-card h3 { margin: 0; font-family: "Space Grotesk", Verdana, sans-serif; font-size: 1rem; }
  ...
  .copy-action-row button { justify-self: start; min-height: 40px; border: 0; border-radius: 8px; background: var(--jung-dark); color: white; cursor: pointer; font: 700 0.88rem "Space Grotesk", Verdana, sans-serif; padding: 0 14px; }
