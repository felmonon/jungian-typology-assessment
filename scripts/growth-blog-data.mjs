export const growthBlogArticles = [
  {
    slug: 'why-mbti-type-keeps-changing',
    title: 'Why Does My MBTI Type Keep Changing?',
    description: 'Why people get different MBTI results over time, and how cognitive functions explain the pattern better than four-letter labels.',
    date: '2026-05-18',
    readTime: '8 min read',
    tags: ['Mistyping', 'MBTI alternative', 'Cognitive functions'],
    related: [
    ...
    sections: [
      ...
      {
        heading: 'Why normal tests create unstable results',
        body: [
      ...
      {
        heading: 'Cognitive functions give a better explanation',
        body: [
      ...
      {
        heading: 'Stress can distort self-reporting',
        body: [
  ...
  },
  {
    ...
    related: [
      ['/functions/ni', 'Introverted Intuition'],
      ['/functions/fi', 'Introverted Feeling'],
      ['/types/infj', 'INFJ type guide'],
      ['/types/infp', 'INFP type guide'],
    ],
    sections: [
      {
        heading: 'Why INFJ and INFP are commonly confused',
        body: [
          'INFJ and INFP descriptions often sound similar: sensitive, idealistic, private, creative, and interested in meaning. That overlap creates a mistyping trap.',
      ...
      {
        heading: 'The INFJ pattern: Ni-Fe',
        body: [
      ...
      {
        heading: 'The INFP pattern: Fi-Ne',
        body: [
      ...
      {
        heading: 'Use the result as a map',
        body: [
  ...
  },
  {
    ...
    sections: [
      {
        heading: 'The wrong way to compare INTJ and INTP',
        body: [
      ...
      {
        heading: 'The INTJ pattern: Ni-Te',
        body: [
      ...
      {
        heading: 'The INTP pattern: Ti-Ne',
        body: [
  ...
  },
  {
    ...
    sections: [
      {
        heading: 'The inferior function in plain language',
        body: [
      ...
      {
        heading: 'Inferior does not mean bad',
        body: [
      ...
      {
        heading: 'Use it as a growth edge',
        body: [
  ...
  },
  {
    ...
    related: [
      ['/blog/understanding-the-grip', 'Understanding the grip'],
      ['/inferior-function-test', 'Inferior function test'],
    ...
    sections: [
      {
        ...
        body: [
          'Shadow work is not about labeling yourself as broken. It is about noticing what you reject, exaggerate, envy, or project onto other people.',
          ...
          'If you do not know your likely function pattern yet, take the free TypeJung assessment first and return to the prompts that match your dominant-inferior axis.',
        ],
      },
      {
        heading: 'Thinking shadow prompts',
        body: [
      ...
      {
        heading: 'Feeling shadow prompts',
        body: [
      ...
      {
        heading: 'Sensation shadow prompts',
        body: [
      ...
      {
        heading: 'Intuition shadow prompts',
        body: [
      ...
      {
        heading: 'A safer way to integrate',
        body: [
  ...
  },
  {
    ...
    sections: [
      {
        heading: 'What makes a better MBTI alternative',
        body: [
      ...
      {
        heading: 'Look for function-level results',
        body: [
      ...
      {
        heading: 'Look for stress and shadow patterns',
        body: [
      ...
      {
        heading: 'Look for transparent pricing',
        body: [
