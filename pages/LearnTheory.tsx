        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-20">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="card-elevated p-6 border-l-4 border-jung-accent">
                ...
                <p className="text-jung-muted text-sm mt-4 italic">
          ...
          <section className="mb-20">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              <div className="card-elevated p-6 border-t-4 border-jung-accent">
                ...
                <p className="text-jung-muted text-sm mb-4">
              ...
              <div className="card-elevated p-6 border-t-4 border-jung-primary">
                ...
                >
                  <div className="space-y-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div className="bg-jung-accent/5 rounded-lg p-4 border border-jung-accent/20">
          ...
          <section className="mb-20">
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-xl p-6 mb-6">
              <h4 className="font-serif font-bold text-amber-900 mb-4">Signs You May Be "In the Grip"</h4>
            ...
            <details className="card-elevated overflow-hidden group">
              ...
              <div className="p-5 pt-0 space-y-4 border-t border-jung-border">
          ...
          <footer className="pt-12 border-t border-jung-border text-center">
            ...
            <p className="mt-6 text-xs text-jung-muted">© 2026 Jungian Typology Assessment</p>
          </footer>
        </div>
      </div>
    </div>
