...
export const QuickInsights: React.FC<QuickInsightsProps> = ({ results }) => {
  ...
  return (
    <section className="mb-12 card-elevated p-6 md:p-8">
      <h2 className="text-heading text-xl md:text-2xl mb-6 flex items-center gap-3 font-serif">
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        <div className="bg-emerald-50/50 rounded-xl p-6 border border-emerald-200/50">
          <h3 className="font-semibold text-emerald-800 mb-4 font-serif">Strengths of Your Profile</h3>
        ...
        <div className="bg-jung-surface-alt rounded-xl p-6 border border-jung-border">
          <h3 className="font-semibold text-jung-dark mb-4 font-serif">Potential Blind Spots</h3>
          <ul className="space-y-3 text-sm text-jung-secondary">
            <li className="flex items-start gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-jung-muted mt-2 flex-shrink-0" />
      ...
      <div className="bg-jung-surface rounded-xl p-6 mb-8 border border-jung-border">
        <h3 className="font-semibold text-jung-dark mb-3 flex items-center gap-2 font-serif">
      ...
      <div className="bg-jung-accent-light rounded-xl p-6 border-l-4 border-jung-accent">
        <h3 className="font-semibold text-jung-dark mb-3 font-serif">Your Growth Edge (Individuation Path)</h3>
        <p className="text-body text-sm text-jung-secondary mb-3">
        ...
        <p className="text-body text-sm text-jung-muted italic font-serif">
      ...
      <div className="mt-8 text-center">
        <p className="text-body text-jung-muted italic text-sm font-serif">
